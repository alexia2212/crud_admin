...
import com.example.reporteincidenciasadmin.beans.BUsuarios;
import com.example.reporteincidenciasadmin.daos.UsersDao;
...
public class ServletAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "InicioSesion":
                requestDispatcher = request.getRequestDispatcher("inicioSesion.jsp");
            ...
            case "ListaUsuarios":
                ...
                requestDispatcher = request.getRequestDispatcher("listaUsuarios.jsp");
                requestDispatcher.forward(request, response);
                break;
            case "Editar":
                ...
                if (user != null) { //abro el form para editar
                    ...
                    requestDispatcher = request.getRequestDispatcher("edituser.jsp");
                    requestDispatcher.forward(request, response);
                ...
                break;
            case "nuevoUsuario":
                requestDispatcher = request.getRequestDispatcher("registarusuario.jsp");
                requestDispatcher.forward(request, response);
                break;

    ...
    <center>
        <div class="card" style="width: 48rem; background-color:#00000090">
            ...
            <div class="d-grid gap-2 col-8 mx-auto">
                <a href="<%=request.getContextPath()%>/ServletAdmin?action=InicioSesion"><button class="btn btn-light" type="button" class="btn btn-secondary" style="color:#686B6E ; width: 15rem; font-size: 15px;"><b>Iniciar Sesión</b></button></a>
                <br>
                <a href="<%=request.getContextPath()%>/ServletInicio?action=registro" style="color: rgb(141, 15, 15);"><button class="btn btn-light" type="button" style="color:#686B6E; width: 15rem; font-size: 15px;"><b>Registrarse</b></button></a>
                <br>
            </div>
        </div>

...
<jsp:useBean id="admin" scope="request" type="com.example.reporteincidenciasadmin.beans.BUsuarios"/>
...
<nav class="navbar navbar-expand-lg" style="background-color: #131950;" aria-label="Eighth navbar example">
    <div class="container">
        <a class="navbar-brand" href="<%=request.getContextPath()%>/ServletAdmin?action=Inicio"><img src="Images/logopucp.png" alt="Logo" width="40" height="40" class="d-inline-block align-text-top"><b style="color:#FFFFFF"> GIGACONTROL</b></a>
...
<div class="container" style="width: 500px;">
    <div class="abs-center">
        <img src="Images/usu.png" class="rounded mx-auto d-block " alt="userphoto" height="200rem" width="200rem">
        <br>
